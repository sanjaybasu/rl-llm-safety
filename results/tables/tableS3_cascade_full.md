...
| claude_opus_4_7_rag × LogReg+TF-IDF | 0.218 | 0.921 | 0.200 | 0.209 | 0.134 |
| claude_opus_4_7_rag × CQL reward-opt | 0.218 | 0.919 | 0.196 | 0.206 | 0.131 |
| claude_opus_4_7_rag × Claude Opus 4.7 | 0.188 | 0.940 | 0.218 | 0.202 | 0.137 |
| ActionHead × Claude Opus 4.7 | 0.176 | 0.945 | 0.223 | 0.197 | 0.135 |
| Claude Opus 4.7 × XGBoost+SBERT | 0.158 | 0.944 | 0.202 | 0.177 | 0.114 |
| ActionHead × claude_opus_4_7_rag | 0.139 | 0.964 | 0.256 | 0.180 | 0.137 |
| claude_opus_4_7_rag × XGBoost+SBERT | 0.115 | 0.954 | 0.184 | 0.142 | 0.086 |
...
| claude_opus_4_7_rag × Guardrails | 0.024 | 0.992 | 0.210 | 0.043 | 0.046 |
| claude_opus_4_7_rag × Constellation | 0.024 | 0.989 | 0.167 | 0.042 | 0.034 |
| Gemini 3.1 Pro × XGBoost+SBERT | 0.018 | 0.999 | 0.600 | 0.035 | 0.094 |
| Claude Opus 4.7 × CQL sens-opt | 0.018 | 0.998 | 0.500 | 0.035 | 0.083 |
| claude_opus_4_7_rag × Gemini 3.1 Pro | 0.018 | 0.997 | 0.333 | 0.035 | 0.061 |
...
| claude_opus_4_7_rag × CQL sens-opt | 0.006 | 1.000 | 0.500 | 0.012 | 0.048 |
